    ...
    <section className={styles.sub_section_alternative} id="projects">
      ...
      <div className={styles.project_container}>
        <div ref={project1} className={styles.project_card} onClick={()=> {setElement(project1)  ; setShowModal(true)} }>
           <img className={styles.project_image} src="/project-image.png" alt=""/>
        ...
        <div ref={project2} className={styles.project_card}   onClick={()=> {setElement(project2)  ; setShowModal(true)} }>
           <img className={styles.project_image} src="" alt=""/>
            <h3 className={styles.project_title}>Project Two</h3>
           <p className={styles.subtext}>This it's a Calendar App  where you can become a member and register events with descriptions at a specific time in your calendar </p>
           <hr/>
           <p className={styles.link}>View Here</p>
        </div>
        ...
        <div ref={project4} className={styles.project_card}   onClick={()=> {setElement(project4)  ; setShowModal(true)} }>
           ...
           <p className={styles.subtext}>maybe you don't want to keep your notes in solid right? And that's why I present you this JournalApp application, here you can become a member and add your notes with images and description included, I hope you enjoy it </p>
           <hr/>
           <p className={styles.link}>View Here</p>
        </div>
